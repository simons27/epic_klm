// This file, including the header is based on a copy of the Solenoid constructor
...
static Ref_t create_detector(Detector& description, xml_h e, SensitiveDetector sens)
{
  ...
  // new addition to create sensitive volumes:
  ...
  for (xml_coll_t l_iter(x_det, _U(layer)); l_iter; ++l_iter, ++i_layer) {
    ...
    // test:
    //l_vol.setSensitiveDetector(sens);
...
DECLARE_DETELEMENT(epic_KLMLBL, create_detector)
